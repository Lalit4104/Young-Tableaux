...
// helper function use in substraction of two polynomails
void help_substraction_poly(map<vector<int>,int>&p1,map<vector<int>,int>p2){
    for(auto i:p2){
...
map<vector<int>,int> substraction_poly(map<vector<int>,int>p1,map<vector<int>,int>p2,float n1=1,float n2=1){
